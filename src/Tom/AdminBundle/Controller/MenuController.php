...
use Tom\AdminBundle\Form\Type\MenuDeleteType;
...
class MenuController extends Controller {
    ...
    public function deleteAction($id, $token) {
        ...
        if (!$csrfProvider->isCsrfTokenValid($tokenName, $token)) {
            ...
            $CountChildren = $RepoMenu->getChildrenCount($id);
            ...
            if ($CountChildren == 0) {
                ...
                $this->addFlash('warning', sprintf('Pozycja menu nie zostala usunięta, poniważ zawiera %d pozycji podrzędnych.', $CountChildren));
            }
        }
