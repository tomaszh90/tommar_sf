...
return array(
	...
	'Upload_java_help' => "Pokud se Java Applet nechce načíst: 1. ujistěte se, že Java je nainstalována ve vašem počítači <a href='http://java.com/en/download/'>[odkaz pro stažení]</a> 2. ujistěte se, že nic není blokováno firewallem",
	'Upload_base_help' => "Přetáhněte soubor(y) do prostoru výše nebo do něj klikněte myší (pro novější prohlížeče) v krajním případě vyberte soubory a klikněte na tlačítko. Po dokončení nahrávání klikněte na tlačítko zpět umístěné v horní části okna.",
	'Type_dir' => 'adresář',
	'Type' => 'Typ',
	'Dimension' => 'Rozměr',
	'Size' => 'Velikost',
	...
	'Paste_Confirm' => 'Skutečně vložit obsah schránky do této složky? Pokud se objeví existující soubory či složky, budou přepsány.',
	...
	'Copy_Cut_Not_Allowed' => 'Nemáte oprávnění %s soubory.', // %s(1) = cut or copy, %s(2) = files or folders
	'Aviary_No_Save' => 'Obrázek nelze uložit',
	'Zip_No_Extract' => 'Nelze rozbalit. Soubor může být poškozen.',
	'Zip_Invalid' => 'Přípona není podporována. Povolené: zip, gz, tar.',
	'Dir_No_Write' => 'Adresář, který jste vybrali, není zapisovatelný.',
	...
	'File_Permission_Wrong_Mode' => "Požadujete nesprávný mód oprávnění.",
	'User' => 'Uživatel',
	'Group' => 'Skupina',
	'Yes' => 'Ano',
	'No' => 'Ne',
	'Lang_Not_Found' => 'Jazyk nelze najít.',
	'Lang_Change' => 'Změnit jazyk',
	'File_Not_Found' => 'Soubor nelze najít.',
	'File_Open_Edit_Not_Allowed' => 'Nemáte oprávnění %s tento soubor.', // %s = open or edit
	'Edit' => 'Upravit',
	'Edit_File' => "Upravit obsah soubor",
